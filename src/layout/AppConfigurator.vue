...
function getPresetExt(): PresetExtension {
  const color = primaryColors.value.find((c) => c.name === layoutConfig.primary)

  if (!color) {
    throw new Error(`Color ${layoutConfig.primary} not found`)
  }
...
function updateColors(type: 'primary' | 'surface', color: Color): void {
  if (type === 'primary') {
...
function applyTheme(type: 'primary' | 'surface', color: Color): void {
  if (type === 'primary') {
